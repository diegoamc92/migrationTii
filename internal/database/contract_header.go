...
//func InsertContractHeaderForPoliza(db *sql.Tx, ramo string, nPoliza string) (int64, error) {
//	query := `
...
//    `
//
//	res, err := db.Exec(query, ramo, nPoliza)
//	if err != nil {
//		return 0, fmt.Errorf("error insertando CONTRACT_HEADER: %v", err)
//	}
//
//	contractID, err := res.LastInsertId()
//	if err != nil {
//		return 0, fmt.Errorf("error obteniendo CONTRACT_ID: %v", err)
//	}
//
