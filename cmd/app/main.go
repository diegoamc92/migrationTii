...
func main() {
	...
	//	// Insertar en POLICY
	//	if err := database.InsertIntoPolicy(tx, contractID); err != nil {
	//		log.Printf("Error insertando en POLICY para CONTRACT_ID %d: %v", contractID, err)
	//		// Continuar con el siguiente CONTRACT_ID si ocurre un error
	//		continue
	//	}
	//	// Insertar en REQUEST
